...
import { LayoutDashboard, Receipt, FileText, Settings, HelpCircle, Images, LogOut, Megaphone, Palette } from "lucide-react";
...
const nav = [
  ...
  { label: "Marketing", href: "/marketing", icon: Palette },
